...
unitTest __test_util_c[] = {{"test_utilString2ll", test_utilString2ll}, {"test_utilString2l", test_utilString2l}, {"test_util_ll2string", test_util_ll2string}, {"test_util_ld2string", test_util_ld2string}, {"test_utilFixedpoint_d2string", test_utilFixedpoint_d2string}, {"test_utilVersion2num", test_utilVersion2num}, {"test_utilReclaimFilePageCache", test_utilReclaimFilePageCache}, {NULL, NULL}};
