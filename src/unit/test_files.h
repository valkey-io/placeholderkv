...
unitTest __test_hashset_c[] = {{"test_cursor", test_cursor}, {"test_set_hash_function_seed", test_set_hash_function_seed}, {"test_add_find_delete", test_add_find_delete}, {"test_add_find_delete_avoid_resize", test_add_find_delete_avoid_resize}, {"test_instant_rehashing", test_instant_rehashing}, {"test_bucket_chain_length", test_bucket_chain_length}, {"test_two_phase_insert_and_pop", test_two_phase_insert_and_pop}, {"test_scan", test_scan}, {"test_iterator", test_iterator}, {"test_safe_iterator", test_safe_iterator}, {"test_random_element", test_random_element}, {"test_random_element_with_long_chain", test_random_element_with_long_chain}, {"test_all_memory_freed", test_all_memory_freed}, {NULL, NULL}};
...
unitTest __test_kvstore_c[] = {{"test_kvstoreAdd16Keys", test_kvstoreAdd16Keys}, {"test_kvstoreIteratorRemoveAllKeysNoDeleteEmptyHashset", test_kvstoreIteratorRemoveAllKeysNoDeleteEmptyHashset}, {"test_kvstoreIteratorRemoveAllKeysDeleteEmptyHashset", test_kvstoreIteratorRemoveAllKeysDeleteEmptyHashset}, {"test_kvstoreHashsetIteratorRemoveAllKeysNoDeleteEmptyHashset", test_kvstoreHashsetIteratorRemoveAllKeysNoDeleteEmptyHashset}, {"test_kvstoreHashsetIteratorRemoveAllKeysDeleteEmptyHashset", test_kvstoreHashsetIteratorRemoveAllKeysDeleteEmptyHashset}, {NULL, NULL}};
...
struct unitTestSuite {
    ...
    {"test_hashset.c", __test_hashset_c},
